...
var embeddedMessages = map[string]map[string]string{
	"en": {
		"app.title":                              "🐳 Docsh - Docker Command Mapping Shell",
		"app.description":                        "A convenient shell that converts Linux commands to Docker commands",
		"app.exit_instruction":                   "Type 'exit' to quit",
		"app.welcome":                            "Welcome to Docsh! Docker Command Mapping Shell.\nType 'help' for help, 'exit' to quit.\n",
		"app.goodbye":                            "Goodbye!",
		"app.error":                              "Error: %v",
		"shell.runtime_info":                     "=== 🐳 Docsh ===",
	...
	"ja": {
		"app.title":                              "🐳 Docsh - Docker Command Mapping Shell",
		"app.description":                        "LinuxコマンドをDockerコマンドに変換する便利なシェル",
		"app.exit_instruction":                   "終了するには 'exit' と入力してください",
		"app.welcome":                            "Docsh へようこそ！Docker Command Mapping Shell.\n'help' でヘルプを表示、'exit' で終了します。\n",
		"app.goodbye":                            "さようなら！",
		"app.error":                              "エラー: %v",
		"shell.runtime_info":                     "=== 🐳 Docsh ===",
...
func DetectLanguage(args []string) string {
	...
	// 環境変数から検出（docsh を優先、旧 CHERRYSH_LANG も後方互換）
	if lang := os.Getenv("DOCSH_LANG"); lang != "" {
		return lang
	}
